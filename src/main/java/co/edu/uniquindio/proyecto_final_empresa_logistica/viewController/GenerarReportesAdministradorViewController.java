...
import co.edu.uniquindio.proyecto_final_empresa_logistica.controller.AdministradorController;
...
public class GenerarReportesAdministradorViewController {
    ...
    private void generarReportes() {
        ...
        if (administradorController.generarReporteAdministrador(cbxTipoDocumento.getSelectionModel().getSelectedItem())) {
    ...
    void initialize() {
        ...
        administradorController = new AdministradorController(app.empresaLogistica);
